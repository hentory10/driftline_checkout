  ...
  try {
    ...
    const { error: bookingError } = await supabase
      ...
      .insert({
        ...
        numberOfAdults:   numberOfAdults != null ? parseInt(numberOfAdults.toString()) : null,
        numberOfChildren: numberOfChildren != null ? parseInt(numberOfChildren.toString()) : null,
